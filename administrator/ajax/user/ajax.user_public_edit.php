			...
			<div class="box-body">
				<div class=" col-md-6">
					...
					<div class="form-group">
                        ...
                        <select class="form-control select2"  value="" required name="phanbien" id="permission">
                            <option value="">Vui lòng chọn</option>
                            <option <?php if($user["phanbien"] == 0) echo 'selected'?>value="0">Không đồng ý</option>
                            <option <?php if($user["phanbien"] == 1) echo 'selected'?> value="1">Đồng ý</option>
				...
				<div class=" col-md-6">
					<div class="form-group">
                        <label>Học vị</label>
                        <input name='hocvi' class="form-control" type="text" value="<?php echo  $user["hocvi"] ?>" />
                    </div>
					<div class="form-group">
					...
					<!--div class="form-group">
						<label>Vai trò</label>
						<select class="form-control"  required name="menu_privilege" id="menu_privilege">
							<option value="">Vui lòng chọn</option>
							<option value="MAKER">Biên tập nội dung</option>
							<option value="CHECKER">Kiểm duyệt nội dung</option>
