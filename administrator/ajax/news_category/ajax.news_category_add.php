					...
					<div class="tab-content">
						<div class="active tab-pane" id="info_general">
							<div class="form-group">
								<label for="parent" class="col-sm-2 col-md-2 col-lg-2 control-label hidden">Thuộc danh mục cha:</label>
								...
								<label for="position" class="col-sm-2 col-md-2 col-lg-2 control-label hidden">Vị trí hiển thị :</label>
								<div class="col-sm-4 col-md-4 col-lg-4 hidden">
