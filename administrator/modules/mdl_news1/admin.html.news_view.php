		...
		<div class="col-xs-12">
			<div class="box">
				...
				<ul class="nav nav-tabs">
				  <li class="<?php if($_REQUEST['tab'] == 'menu4'){ echo 'active';} ?>"><a href="index.php?module=news&tab=menu4">Chờ biên tập</a></li>
				  ...
				  <li class="<?php if($_REQUEST['tab'] == 'menu5'){ echo 'active';} ?>"><a href="index.php?module=news&tab=menu5">Trả lại</a></li>
							...
							<tbody>
								...
								?>
									<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle" <?php if($new->news_position == 1) {echo 'style="background: #efe9a2;"';} if($new->news_position == 2) {echo 'style="background: #b6e9e4;"';}  if($new->news_position == 3) {echo 'style="background: #e7c9ab;"';} if($new->news_position == 4) {echo 'style="background: #32b12952;"';} ?>>
										...
										<td class="text-right"><?php echo $new->number_view ?></td>
										<td class="text-center">
					...
					<div class="box-body table-responsive">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								foreach ($news as $new) {
									$i++;
									if($new->post_type == 'member'){
									
								?>
									<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle" <?php if($new->news_position == 1) {echo 'style="background: #d0d0d0;"';} if($new->news_position == 2) {echo 'style="background: #b6e9e4;"';}  if($new->news_position == 3) {echo 'style="background: #e7c9ab;"';} if($new->news_position == 4) {echo 'style="background: #32b12952;"';} ?>>
										<td  class="text-center">
											<?php echo $i ?>
										</td>
										<td><a target="_blank" href="<?=$ariacms->actual_link . 'chi-tiet/' . $new->url_part . '.html'?>"><?=$new->title_vi?></a> </td>
