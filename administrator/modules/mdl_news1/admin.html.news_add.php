											...
											<div class="active tab-pane" id="info_general">
													...
													<div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<div class="col-sm-12 col-md-12 col-lg-12">
																<textarea class="form-control" name="content_vi" id="content_vi" rows="80"></textarea>
															</div>
												...
												<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-md-12">
															...
															<select class="form-control select2" id="post_tags" multiple="multiple" name="taxonomy[]"  data-placeholder="Chọn xu hướng..." style="width: 100%;">
																<?php
																foreach ($taxonomies as $taxonomy) {
																	if ($taxonomy->taxonomy == 'post_tags' && $taxonomy->parent == 0 && $taxonomy->status == 'active') {
																		$selected = (in_array($taxonomy->id, $term_taxonomy_id_list)) ? 'selected' : '';
																		echo '<option '. $selected .' value="' . $taxonomy->id . '">' . $taxonomy->title_vi . '</option>';
																		if ($taxonomy->sub > 0) {
																			foreach ($taxonomies as $taxonomy_sub) {
													...
													<div class="form-group">
														...
														<div class="col-xs-12 col-md-12">
															...
															<label>Từ khóa<span class="text-red">*<span></label>
															<input class="form-control" name="tukhoa" id="tukhoa" placeholder="Từ khóa" type="text" required value="" />
														</div>
												...
												<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
													...
													<div class="form-group row">
														...
														<input type="file" name="hinhanh" id="img" style="display:none" onchange="readURL(this)" accept="image/png, image/jpeg" required>
