							...
							<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
								...
								<div class="form-group">
									<div class="col-xs-12">
										...
										<textarea class="form-control" name="brief_vi" rows="3" id="brief_vi" placeholder="Tóm tắt giới thiệu bản tin..."><?=$news_detail['brief_vi']?></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-xs-12 col-md-6">
										<label>Danh mục - Category<span class="text-red">*<span></label>
									...
									<div class="col-xs-12 col-md-6">
										<label >Quản lý hiển thị<span class="text-red">*<span></label>
										<select id="news_position" name="news_position" class="form-control" required>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-md-12">
											...
											<input class="form-control" name="tukhoa" id="tukhoa" placeholder="Từ khóa" required type="text" value="<?=$news_detail['tukhoa']?>" />
										</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-md-6">
										<label >Nguồn tham khảo </span></label>
								...
								<div class="form-group row">
									...
									<label for="staticEmail" class="col-sm-6 col-xs-12 col-form-label">Ảnh đại diện<span class="text-red">:<?php 
										...
										<input type="file" name="hinhanh" id="img" style="display:none" onchange="readURL(this)" accept="image/png, image/jpeg" value=""  >
