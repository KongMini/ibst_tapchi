...
$query = "SELECT a.* FROM e4_tapchi a 
	WHERE a.type='tapchi' and a.id = $id";
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="modal-dialog modal-wide">
                        <form method="POST" action="?module=tapchi&task=news_edit&id=<?php echo $id ?>" name="news_edit"
                              id="news_edit" class="form-horizontal" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="form-group row ">
                                                            <div class="col-xs-6">
																...
																<textarea class="form-control" rows="3" name="tacgia_vi"
                                                                          id="tacgia_vi"
                                                                          placeholder="Tác giả..."
                                                                          ><?php echo $news_detail['tacgia_vi'] ?></textarea>			
                                                            ...
                                                            <div class="col-xs-6">
																...
																<textarea class="form-control" rows="3" name="tacgia_en"
                                                                          id="tacgia_en"
                                                                          placeholder="Tác giả..."
                                                                          ><?php echo $news_detail['tacgia_en'] ?></textarea>	
                                                        ...
                                                        <div class="form-group">
															...
															<div class="col-xs-12">
																	...
																	<input class="form-control" name="time_edited" id="aproved_date"
																		   type="date"
																		   value="<?php echo date("Y-m-d",$news_detail['time_edited']) ?>"/>
																</div>
                                                        </div>
														...
														<div class="col-xs-12 col-md-6">
															...
															<input class="form-control" name="tukhoa_vi" id="tukhoa_vi" placeholder="Từ khóa" type="text" value="<?php echo $news_detail['tukhoa_vi'] ?>" />
														</div>
                                                        <div class="col-xs-12 col-md-6">
                                                            <label>Từ khóa Tiếng Anh</label>
                                                            <input class="form-control" name="tukhoa_en" id="tukhoa_en" placeholder="Từ khóa" type="text" value="<?php echo $news_detail['tukhoa_en'] ?>" />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            ...
                                                            <textarea  class="form-control" name="tailieuthamkhao_vi" id='tailieuthamkhao_vi'  placeholder="Tài liệu tham khảo"><?php echo $news_detail['tailieuthamkhao_vi'] ?></textarea>
                                                        </div>
														<div class="col-xs-12 col-md-6">

															<label>Tài liệu tham khảo Tiếng Anh</label>
                                                            <textarea  class="form-control" name="tailieuthamkhao_en" id='tailieuthamkhao_en'  placeholder="Tài liệu tham khảo"><?php echo $news_detail['tailieuthamkhao_en'] ?></textarea>
                                                        </div>
                                                        ...
                                                        <div class="form-group row ">
                                                            <div class="col-xs-6">
                                                                ...
                                                                <input class="form-control" name="file_vi"
                                                                       ...
                                                                       value="<?php echo $news_detail['file_vi'] ?>"/>
                                                            </div>
                                                            <div class="col-xs-6">
                                                                ...
                                                                <input class="form-control" name="file_en"
                                                                       ...
                                                                       value="<?php echo $news_detail['file_en'] ?>"/>
                                                            </div>
                                                        </div>
                            ...
                            <div class="modal-footer">
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-primary" id="capnhat" name="submit"
                                                value="news_edit">Cập nhật
                                        </button>
                                        <?php if ($_SESSION['user']['role_type'] == 'ADMIN' && $news_detail['post_status'] != 'active') { ?>
                                            <button type="submit" class="btn btn-warning" id="xuatban" name="submit"
                                                    value="xuatban">Xuất bản
                                            </button>
                                        <?php } ?>
                                        <?php if ($_SESSION['user']['role_type'] == 'ADMIN' || $_SESSION['user']['role_type'] == 'CHECK') { ?>
                                            <?php if ($news_detail['post_status'] == 'active') { // Nếu đã duyệt hiển thị nút gỡ, cập nhật ?>
                                                <button type="submit" class="btn btn-danger" id="gobaidang"
                                                        name="submit" value="gobaidang">Gỡ bài
                                                </button>
                                            <?php } elseif ($news_detail['post_status'] == 'waiting') { // Nếu đang chờ duyệt thì hiển thị nút đăng, hủy, cập nhật ?>
                                                <button type="submit" class="btn btn-danger" id="tuchoi" name="submit"
                                                        value="tuchoi">Từ chối
                                                </button>
                                            <?php } elseif ($news_detail['post_status'] == 'deactive' || $news_detail['post_status'] == 'lock') { // Nếu từ chối hiển thị nút duyệt tin trạng thái chờ, cập nhật ?>
                                                <button type="submit" class="btn btn-warning" id="choxuly" name="submit"
                                                        value="choxuly">Chờ xử lý
                                                </button>
                                            <?php } ?>
                                        <?php } ?>
