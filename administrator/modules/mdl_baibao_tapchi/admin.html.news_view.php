...
global $database;
	...
	$query = "SELECT * FROM `e4_chude`";
	$database->setQuery($query);
	$chude = $database->loadObjectList();
?>
<section class="content-header">
			<h1>
				<a class="col-lg-3 col-md-4 col-sm-4 col-xs-12 btn-lg btn btn-warning " href="index.php?module=<?php echo $_REQUEST['module'] ?>"><i class="fa fa-files-o"></i> Quản lý tạp chí</a>
			</h1>
			<a class="btn btn-warning pull-right"  href="index.php?module=tapchi&task=news_add">Thêm mới <i class="fa fa-plus"></i></a>
		</section>
		...
		<div class="col-xs-12">
			<div class="box">
				...
				<ul class="nav nav-tabs">
				  <li class="<?php if($_REQUEST['tab'] == 'home'){ echo 'active';} ?>"><a href="index.php?module=tapchi&tab=home">Chờ xuất bản</a></li>
				  <li class="<?php if($_REQUEST['tab'] == 'menu1'){ echo 'active';} ?>"><a href="index.php?module=tapchi&tab=menu1">Đã xuất bản</a></li>
				  <li class="<?php if($_REQUEST['tab'] == 'menu3'){ echo 'active';} ?>"><a href="index.php?module=tapchi&tab=menu3">Đã gỡ</a></li>
				</ul>
							...
							<tbody>
								<form method="get" action="index.php" name="form_news_search" id="form_news_search">
									...
									<tr>
										...
										<td>
											<select name="linhvuc" id="linhvuc" class="form-control" onchange="this.form.submit();">
												<option value="">- Chọn -</option>
												<?php
												foreach ($linhvuc as $value) {
												?>
													<option value="<?php echo $value->id ?>" <?php echo ($_REQUEST['linhvuc'] == $value->id) ? 'selected="selected"' : ''; ?>><?php echo $value->title_vi .'-'. $value -> nam  ?></option>
												<?php
												}
												?>
											</select>
										...
										<td>
											<select name="chude" id="chude" class="form-control" onchange="this.form.submit();">
												<option value="">- Chọn -</option>
												<?php
											
													foreach ($chude as $value) {
															?>
															<option value="<?php echo $value->id ?>" <?php echo ($_REQUEST['chude'] == $value->id) ? 'selected="selected"' : ''; ?>><?php echo $value->title_vi ?></option>
														<?php 
													}
												?>
											</select>
								...
								?>
									<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle" <?php if($new->news_position == 1) {echo 'style="background: #efe9a2;"';} if($new->news_position == 2) {echo 'style="background: #b6e9e4;"';}  if($new->news_position == 3) {echo 'style="background: #e7c9ab;"';} if($new->news_position == 4) {echo 'style="background: #32b12952;"';} ?>>
										...
										<td><?php echo $new->linhvuc . '-' . $new->nam?></td>
										<td><?php echo $new->chude ?></td>
										<td>
										...
										<?php
											...
											echo '<a href="index.php?module=tapchi&task=news_edit&id=' . $new->id . '" ><i class="fa fa-pencil-square-o" data-toggle="tooltip" title="Cập nhật thông tin"></i></a>&nbsp;&nbsp;';
							...
							<tbody>
								...
								?>
									<tr class="<?php echo ($i % 2 == 1) ? 'bg-gray-light' : ''; ?> valign-middle" <?php if($new->news_position == 1) {echo 'style="background: #efe9a2;"';} if($new->news_position == 2) {echo 'style="background: #b6e9e4;"';}  if($new->news_position == 3) {echo 'style="background: #e7c9ab;"';} if($new->news_position == 4) {echo 'style="background: #32b12952;"';} ?>>
										...
										<td><?php echo $new->chude ?></td>
										<td>
											<?php echo ($new->post_created) ? $ariacms->unixToDate($new->time_edited, '/') : ''; ?>
										</td>
