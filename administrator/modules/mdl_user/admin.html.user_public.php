			...
			<div class="box">
				...
				<div class="box-body">
					<form action="?module=<?php echo $_REQUEST['module'] ?>&task=user_view" method="GET">
						...
						<input type="hidden" value="<?php echo $_REQUEST['task'] ?>" name="task" />
						<div class="row box-body">
                            ...
                            <div class="col-md-2 ">
                                <select name="phanbien" class="form-control">
                                    <option value="">Quyền</option>
                                    <option value="0" <?php echo ($_REQUEST['status'] == 2) ? "selected" : "" ?>>Tác giả</option>
                                    <option value="1" <?php echo ($_REQUEST['status'] == 1) ? "selected" : "" ?>>Tác giả, Phản biện</option>
                                </select>
                            </div>
							<div class="col-md-2 ">
						...
						<tbody>
							...
							?>
									<tr>
										...
										<td>Tác giả<?php if($user->phanbien == 1) echo ", Phản biện" ?></td>
										...
										<td>
											...
											?>
											<a href="javascript:void(0);" data-toggle="modal" data-target="#showCNTT" onclick="showCNTT('<?php echo $user->id ?>','ajax/user/ajax.user_public_edit.php')">
												<i class="fa fa-edit" data-toggle="tooltip" title="Cập nhật thông tin"></i>
											</a>&nbsp;
											<!--<a href="javascript:void(0);" data-toggle="modal" data-target="#showCNTT" onclick="showCNTT('<?php echo $user->id ?>','ajax/user/ajax.user_get.php')"><i class="fa fa-user-plus" aria-hidden="true"></i></a>	
											&nbsp;-->
