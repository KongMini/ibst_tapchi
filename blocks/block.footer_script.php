...
<p><i class="fa fa-phone-square" aria-hidden="true"></i>  <a href="tel:<?=$ariacms->web_information->hotline?>">Call</a>  <i class="fa fa-envelope"  aria-hidden="true"></i>  <a href="<?=$ariacms->actual_link?>lien-he.html">Liên Hệ</a></p> 
</div>-->
