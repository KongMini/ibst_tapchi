...
$config['licenseName'] = 'tapchi.ibst.vn';
$config['licenseKey']  = 'GD2DCMFK2TNT93KQ7PDVNPJRGAD9T';
...
$link = '/ckfinder/userfiles/';
if($_SESSION['member']){
    $link = '/ckfinder/userfiles/'.$_SESSION['member']['fullname'];
}
