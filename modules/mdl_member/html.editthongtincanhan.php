                        ...
                        <div class="frm_form_fields ">
                            <fieldset>
								...
								<div id="frm_field_6-first_container"
                                    ...
                                    <div id="field_j4r0h_label" class="frm_primary_label"><?= "Ảnh đại diện: " ?>:
                                        <span class="frm_required" aria-hidden="true">*</span>
                                    </div>
									<img src="/ckfinder/userfiles/images/noimage.jpg" style=" width: 20%; border-radius: 30%;" onclick="openPopupImg('Img')" id="newImg">	
                                    <input type="hidden" id="Img" 
                                           name="image_url" id="Img" value="<?= $_SESSION['member']['image_url']?>">
                                ...
                                <div id="frm_field_15_container"
                                    ...
                                    <label for="field_8idq4" id="field_8idq4_label" class="frm_primary_label"><?= _DEGREE ?>
									 ...
									 <input type="text" id="field_j4r0h_last" >
