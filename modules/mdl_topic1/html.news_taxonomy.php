...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Alegreya+Sans:wght@300;400&amp;family=Overpass:wght@300;400&amp;family=Roboto&amp;display=swap" media="print" onload="this.media='all'" /><noscript>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Alegreya+Sans:wght@300;400&amp;family=Overpass:wght@300;400&amp;family=Roboto&amp;display=swap" />
  </noscript>
...
<body>
  ...
  <div class="border-top border-bottom main-content margin-below-sticky-header stripe-bg">
    <div class="flex-container page-header">
      <div class="flex-66">
        <div class="heading-container-left small-page-heading">
          <h1 class="center-on-mobile"> <?= $category[$params->title] ?></h1>
        </div>
      </div>
          ...
          ?>
            <div class="flex-col-portfolio-page">
              <div class="project-container">
                ...
                <div class="client-name-container"><a class="client-name" href="<?= $ariacms->actual_link ?>chi-tiet/<?= $new->url_part ?>.html"><?= $new->{$params->title} ?></a>
