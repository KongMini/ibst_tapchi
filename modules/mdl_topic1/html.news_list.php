...
<body>
	...
	<div class="border-top border-bottom main-content margin-below-sticky-header stripe-bg">
	    <div class="flex-container page-header">
			<div class="flex-66">
			<div class="heading-container-left small-page-heading"><h1 class="center-on-mobile">  Bài báo được xem nhiều</h1></div>
			</div>
			<div class="flex-33 breadcrumbs ">
			<p class="desktop-only"><a href="<?=$ariacms->actual_link?>"><?=_HOME?></a>  / Bài báo được xem nhiều</p>
			</div>
		</div>
</div>
