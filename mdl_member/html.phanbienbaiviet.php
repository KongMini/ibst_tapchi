                    ...
                    <div class="frm_form_fields ">
                        <fieldset>
                            ...
                            <div id="frm_field_7-last_container"
                                ...
                                <textarea required name="tomtat" rows="5" readonly
                ...
                <form action="<?php echo $ariacms->actual_link . 'member/phan-bien.html'; ?>" method="post"
                    ...
                    <div id="frm_field_15_container"
                        ...
                        <select required name="dongy" id="field_8idq4">
                            <option value="">Ý kiến phản biện</option>

                            <option value="0" <?php if ($value->id == $phanbien['dongy']) echo "selected"; ?>> Không
                                đồng ý
                                đăng
                            </option>
                            <option value="1" <?php if ($value->id == $phanbien['dongy']) echo "selected"; ?>> Đồng ý
                                đăng
                                có chỉnh sửa
                            </option>
                            <option value="2" <?php if ($value->id == $phanbien['dongy']) echo "selected"; ?>> Đồng ý
                                đăng
                            </option>
