                    ...
                    <div class="frm_form_fields ">
                        <fieldset>
                            ...
                            <div id="frm_field_7-last_container"
                                ...
                                <textarea  name="tomtat_en" rows="5"
                            ...
                            <div class="frm_submit" style="text-align: center">
                                <?php if (($member_posts['status'] == 'chotiepnhan'  || $member_posts['status'] == 'phanhoitacgia') AND ($isEdit)) { ?>
                                    <button class="frm_button_submit frm_final_submit" type="submit"
                                            formnovalidate="formnovalidate" name="submit" value="user"><?= _EDIT ?>
                                    </button>
                                <?php } ?>
