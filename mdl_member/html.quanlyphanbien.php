                        ...
                        <div class="flex items-center space-x-1.5 flex-shrink-0 pr-3  justify-center order-1">
							...
							<table>
							  <tr>
								...
								<th style="width:12%">Ngày phản biện bài báo</th>
								<th style="width:12%">Đánh giá</th>
								<th style="width:10%">Thao tác</th>
							  </tr>
							  
							  <?php foreach($phanbien_posts as $k => $post ) {
							  if($post->dongy == 0 AND $post -> ngaypb > 0){
							  ...
							  <tr>
								...
								<td class="tdst"><?php echo $post->mabaibao ?></td>
								<td class="tdst"><?php echo $post->title_vi ?></td>
								<td class="tdst"><?php echo Date("d-m-Y H:i:s",$post->ngayguipb) ?></td>
								<td class="tdst"><?php echo Date("d-m-Y H:i:s",$post->ngaydongypb) ?></td>
								<td class="tdst"><?php echo Date("d-m-Y H:i:s",$post->ngaypb) ?></td>
